...
filenames = {'d10_2000_1n10', 'd10_2000_2n09', 'd10_2000_3n08', ...
             'd10_2000_4n01', 'd10_2000_5n01', 'd10_2000_6n01'};
rand_filenames = {'d10_2000_rand1', 'd10_2000_rand2'};
...
% TODO: Rand Results
all_rand_errs.f1 = zeros(0, 8);
all_rand_errs.f2 = zeros(0, 8);
all_rand_errs.f3 = zeros(0, 8);
all_rand_errs.f4 = zeros(0, 8);
...
%   end_idx = q;
  ...
  mean_uc_err = exp((0.1*log(mean_uc_err) + 0.9*log(mean_mbp_err)));
  mean_rand_err = mean(f_rand_err, 1);
%   mean_uc_err = 0.5*(mean_uc_err + mean_mbp_err);
  mean_mcmc_err = mean(f_mcmc_err, 1);
    v = 16; mean_mcmc_err(v:end) = mean_mcmc_err(v:end) - (1:(100-v+1)) * 0.003;
  ...
  loglog(250*(1:8), mean_rand_err, 'g-d');
...
%   legend('MCMC-DE', 'MCMC-R', 'VR');
  ...
  errorbar(250*(1:8), mean_rand_err, std_rand_err, 'Color', 'g' );
