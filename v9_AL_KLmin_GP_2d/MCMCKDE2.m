...
[mcmcSamples] = CustomMCMC(NUM_MCMC_QUERIES, ...
  PROPOSAL_STD, MCMCD_INIT_PT, evalLogJoint);

for mcmcd_iter = 1:NUM_MCMC_QUERIES

  [~, mcmProbEst] = kde(mcmcSamples(1:mcmcd_iter, :));
